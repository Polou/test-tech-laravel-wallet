<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-5">
                ...
                <form method="POST" action="{{ route('send-money') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <x-text-input id="recipient_email" class="block mt-1 w-full" type="email"
                            name="recipient_email" :value="old('recipient_email')" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="amount" class="block mt-1 w-full" type="number" min="0"
                            step="0.01" :value="old('amount')" name="amount" required />
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-5">
                <h2 class="text-xl font-bold mb-6">@lang('Make a reccuring transfer')</h2>
                <form method="POST" action="{{ route('send-money-reccuring') }}" class="space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <x-text-input id="frequency" class="block mt-1 w-full" type="number" name="frequency"
